...
@section('title', 'Halaman Data Faq')
@section('faq', 'active')

@section('content')
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Ubah Data Faq</h1>
                    ...
                    <form action="{{ route('faq.update', $data->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" name="question" placeholder="Masukan Pertanyaan" value="{{ old('question', $data->question) }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" name="answer" placeholder="Masukan Jawaban" value="{{ old('answer', $data->answer) }}">
                                </div>
                            </div>
                        </div>
                        <div>
