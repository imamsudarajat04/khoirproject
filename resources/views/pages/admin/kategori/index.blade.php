...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('data-kategori.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered dt-responsive nowrap w-100 display" id="tableKategori">
                            <thead>
                                <tr>
                                    <th width="70px">No</th>
                                    <th>Nama</th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btn btn-danger delete-kategori" value="">
                        <strong>
                            Hapus
                        </strong>
                    </button>
    ...
    <script>
        var datatable = $('#tableKategori').DataTable({
            ...
            "fnCreatedRow": function(nRow, data) {
                $(nRow).attr('id', 'kategori' + data.id);
            },
        });

        $(document).on("click", ".delete_modal", function() {
            var id = $(this).data('id');
            $(".modal-footer .delete-kategori").val(id);
        });

        jQuery(document).ready(function($) {
            ////----- DELETE a link and remove from the page -----////
            jQuery('.delete-kategori').click(function() {
