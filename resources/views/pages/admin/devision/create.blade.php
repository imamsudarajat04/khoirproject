...
@section('title', 'Halaman Devisi Baru')
@section('dataDevisi', 'active')

@section('content')
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah Devisi Baru</h1>
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12">
            <div class="card shadow mb-4">
                <!-- Card Body -->
                <div class="card-body">
                    <form action="{{ route('data-devisi.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <div class="row">
                                <label class="col-12 control-label">Nama Devisi</label>
                                <div class="col-12">
                                    <input type="text" class="form-control" name="name" placeholder="Masukan Nama Devisi" value="{{ old('name') }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <textarea class="form-control" name="description" placeholder="Masukan Deskripsi">{{ old('description') }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class=" form-group">
                        ...
                        <div>
                            <div class="row">
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary btn-block px-5"><i class="fas fa-plus"></i> Tambah Devisi</button>
                                </div>
                            </div>
                        </div>
                    </form>
