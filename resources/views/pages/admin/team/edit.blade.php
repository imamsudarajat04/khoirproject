    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12">
            <div class="card shadow mb-4">
                <!-- Card Body -->
                <div class="card-body">
                    <form action="{{ route('data-team.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="col-12">
                                    <select class="form-control" name="devision_id">
                                        ...
                                        @foreach ($devisions as $devision)
                                            <option value="{{ $devision->id }}" {{ $data->devision_id == $devision->id ? 'selected' : null }}>{{ $devision->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6 mb-2">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <input type="text" class="form-control" name="facebook_link" placeholder="Masukan Link Facebook" value="{{ old('facebook_link', $data->facebook_link) }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 mb-2">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <input type="text" class="form-control" name="twitter_link" placeholder="Masukan Link Twitter" value="{{ old('twitter_link', $data->twitter_link) }}">
                                        </div>
                                    </div>
                                </div>                  
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6 mb-2">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <input type="text" class="form-control" name="instagram_link" placeholder="Masukan Link Instagram" value="{{ old('instagram_link', $data->instagram_link) }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 mb-2">
