...
@section('title', 'Halaman Klient / Sponsor Baru')
@section('client', 'active')

@section('content')
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah Data Klien / Sponsor</h1>
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12">
            <div class="card shadow mb-4">
                <!-- Card Body -->
                <div class="card-body">
                    <form action="{{ route('client-image.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
